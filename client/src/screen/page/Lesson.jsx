...
?>`;
  ...
  return (
    <div id="doc" className="container mx-auto px-4 py-8">
      ...
      <p>ເຊິ່ງຈະເຫັນວ່າຖ້າຫາກເຮົາແທນຄ່າໃນ $user ເປັນ admin ແລະ password ເປັນ RANDOM' or '1'='1 ຈະໄດ້ query ອອກມາເປັນ</p>
      <SyntaxHighlighter language="sql" style={vscDarkPlus}>
        {sqlQuery2}
      </SyntaxHighlighter>
      <p>ເຊິ່ງນັ້ນໝາຍຄວາມວ່າຖ້າຫາກເຮົານຳເອົາຄ່າ <code>admin</code> ໄປປ້ອນໃນ parameter username ແລະ <code>'RANDOM' or '1'='1</code> ໄປປ້ອນໃນ parameter password ຈະເຮັດໃຫ້ເຮົາສາມາດຕອບ login ຫຼື ກໍຄືສາມາດເຂົ້າສູ່ລະບົບໄດ້ໂດຍບໍ່ຕ້ອງຮູ້ລະຫັດຂອງ user ນັ້ນໆໄດ້ເລີຍນັ້ນເອງ.</p>

      <h2 className="text-2xl font-bold mt-8">Question</h2>
      <ul className="list-disc list-inside mb-4">
        <li>ຈົ່ງໃຊ້ຊ່ອງໂຫວ່ SQL Injection ໃນການ bypass login ເປັນ admin ແລ້ວນຳ flag ທີ່ໄດ້ມາຕອບ</li> <li className="mt-8">LAB <a href="http://192.168.100.73:30000/" target="_blank" className="text-blue-500">http://192.168.100.73:30000/</a></li>
      </ul>
      
      <div className="input-container">
        <h3 className="text-xl font-bold mb-4">Submit Your Answers</h3>
        {/* Input box */}
        <input className="border border-gray-300 rounded-md px-4 py-2 mr-2" type="text" placeholder="Your answer..." />
        {/* Submit button */}
